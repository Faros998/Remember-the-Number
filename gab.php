...
$nc = mt_rand(100,999); /*generovani nahodneho cisla*/
?>
...
<body onload="onload()">  <!-- aktivace darkmode na strance -->
 ...
 <div id="ncc">
  ...
  <form action="gab.php" method="POST">   <!-- zobrazeni a odeslani zadanych hodnot -->
    <div id="ff">
    ...
    $html2 = "<div id='jj'>SESSION 2 Level ";
    $html3 = "</div>";                                                                                    
    $html4 = ' <div class="bu-se"><a class="but-ses" href="gac.php">Session 3</a></div>';    // skryti mmodulu
    ...
    $html12 = '</div>';
    $html122 = 2;
    $html13 = '<div id="gg">Session 2 Level ';
    ...
    $html17 ='<center><div id="oo">SUPER!</br>
                                   ...tak jsi to dokázal</br>                               
                                   JSI borec</br>
                                   a to je konec!</br>
                                   <h1><p>&#x1F44F;</p></h1>  </br>
             </div></center>';
    $html18 ='<div id="pp"><a href="gab.php">Try again</a></div>';  // opakovani hry
       ...
       if (($_POST['a']) == ($_POST['c'] )){     // pocet levelu 10
         ...
         if ($_SESSION['views'] == 11){
            ...
            echo " $html13 $html14 $html18 $html16";
